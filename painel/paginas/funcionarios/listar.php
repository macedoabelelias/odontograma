...
<big><a class="{$mostrar_func} btn btn-primary-light btn-sm" href="#" onclick="procedimentos('{$id}', '{$nome}')" title="Inserir Procedimentos"><i class="fa fa-medkit "></i></a></big>

<big><a class="{$mostrar_func} btn btn-success-light btn-sm" href="#" onclick="horarios('{$id}', '{$nome}')" title="Inserir Horários"><i class="fa fa-calendar-plus-o "></i></a></big>
