		...
		<table style="width: 100%; border: 0px solid #ccc;">
			<tr>
				<td style="border: 1px; solid #000; width: 20%; text-align: left;">
					<img style="margin-top: 2px; margin-left: 7px;" id="imag" src="<?php echo $url_sistema ?>img/logo.jpg" width="120px">
				</td>
				...
				<td style="width: 55%; text-align: right; font-size: 9px;padding-right: 10px;">
						<b><big>SOLICITAÇÃO DE EXAMES COMPLEMENTARES</big></b><br>
						<br>
		...
		<table id="" style="border-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:10px;">
			<thead>
    			...
    			<tr >
					...
					<td td colspan="3" style="width:30%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">
    			...
    			<tr >
					<td style="width:9%; border-bottom: : 1px solid #000;"><b>PROFISSÃO: </b></td>
    			...
    			<tr >
					...
					<td style="width:8%; border-bottom: : 1px solid #000;"><b>ENDEREÇO: </b></td>
					<td colspan="3" style="width:13%; border-bottom: : 1px solid #000; border-right: 1px solid #000;">
