		...
		<table style="width: 100%; border: 0px solid #ccc;">
			<tr>
				<td style="border: 1px; solid #000; width: 20%; text-align: left;">
					<img style="margin-top: 1px; margin-left: 7px;" id="imag" src="<?php echo $url_sistema ?>img/logo.jpg" width="120px">
				</td>
...
<br>
		...
		<div align="left" style="margin-top: 35px; margin-bottom: 10px; border-bottom: 1px solid #000; font-size:12px"><b>MEDICAMENTOS</b></div>
