		...
		<table id="" style="border-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:10px;">
			...
			<thead>
    			...
    			<tr >
					...
					<td colspan="3" style="width:13%; border-bottom: : 1px solid #000;  border-bottom: : 1px solid #000">
    			...
    			<tr >
					...
					<td style="width:8%; border-bottom: : 1px solid #000;"><b>ENDEREÇO: </td>
			...
			<thead>
    			...
    			<tr>
    				...
    				<tr>
					<td style="width:15%;"><b>AGENDADO POR: </b></td>
					...
					<td style="width:10%; "><b>LANÇADO EM: </b></td>
